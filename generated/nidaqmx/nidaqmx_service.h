...
public:
  ...
  ::grpc::Status ReadAnalogF64Stream(::grpc::ServerContext* context, const ReadAnalogF64StreamRequest* request, ReadAnalogF64StreamResponse* response) override;
  ...
  ::grpc::Status WaitForNextSampleClockStream(::grpc::ServerContext* context, const WaitForNextSampleClockStreamRequest* request, WaitForNextSampleClockStreamResponse* response) override;
  ...
  ::grpc::Status WriteAnalogF64Stream(::grpc::ServerContext* context, const WriteAnalogF64StreamRequest* request, WriteAnalogF64StreamResponse* response) override;
